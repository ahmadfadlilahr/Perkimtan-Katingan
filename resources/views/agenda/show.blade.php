...
<div class="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50">
    ...
    <div class="bg-white border-b border-gray-100 shadow-sm">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            {{-- Title Section --}}
            <div class="space-y-4">
                <h1 class="text-3xl lg:text-4xl font-light text-gray-900 leading-tight">{{ $agenda->judul }}</h1>
                ...
                <div class="flex flex-wrap items-center gap-6 text-sm text-gray-600">
                    <div class="flex items-center space-x-2">
                        ...
                        <span>{{ \Carbon\Carbon::parse($agenda->tanggal_agenda)->format('d F Y') }}</span>
                    </div>
        ...
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="flex flex-wrap gap-3">
                    {{-- Category Badge --}}
                    <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-indigo-50 text-indigo-700 border border-indigo-200">
                        {{ ucfirst($agenda->kategori) }}
                    </span>

                    {{-- Featured Badge --}}
                    @if($agenda->is_featured)
                        <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-amber-50 text-amber-700 border border-amber-200">
                    ...
                    @else
                        <span class="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-orange-50 text-orange-700 border border-orange-200">
                            <svg class="w-4 h-4 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                @if($agenda->lampiran)
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                        <div class="flex items-center space-x-3 mb-6">
                            ...
                            <div>
                                <h3 class="text-lg font-medium text-gray-900">Lampiran Dokumen</h3>
                                <p class="text-sm text-gray-500">Klik untuk mengunduh file</p>
                            </div>
                        </div>
                        ...
                        <div class="space-y-3">
                            ...
                            @foreach($files as $file)
                                @if($file)
                                    <div class="group relative bg-gray-50 rounded-lg p-4 hover:bg-gray-100 transition-all duration-200">
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-center space-x-3 min-w-0">
                                                ...
                                                <div class="min-w-0 flex-1">
                                                    <p class="text-sm font-medium text-gray-900 truncate">{{ basename($file) }}</p>
                                                    <p class="text-xs text-gray-500">Dokumen</p>
                                                </div>
                                            </div>
                                            <a href="{{ asset('storage/' . $file) }}"
                                               target="_blank"
                                               class="flex-shrink-0 inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md text-indigo-600 bg-indigo-100 hover:bg-indigo-200 transition-colors duration-200">
                ...
                @if($agenda->penyelenggara)
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                        <div class="flex items-center space-x-3 mb-4">
                            ...
                            <div>
                                <h3 class="text-lg font-medium text-gray-900">Penyelenggara</h3>
                                <p class="text-base text-gray-700">{{ $agenda->penyelenggara }}</p>
                            </div>
                        </div>
                    </div>
                @endif
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Informasi Agenda</h3>
                ...
                {{-- Schedule Card --}}
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Jadwal Kegiatan</h3>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <a href="{{ route('agenda.index.public') }}"
                       class="w-full inline-flex items-center justify-center px-4 py-3 text-sm font-medium text-gray-700 bg-gray-50 border border-gray-200 rounded-lg hover:bg-gray-100 hover:border-gray-300 transition-colors duration-200">
