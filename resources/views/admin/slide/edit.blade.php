<x-app-layout>
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-600">
                    Perbarui informasi slide yang sudah ada
                </p>
            </div>
    ...
    <div class="py-8">
        <div class="max-w-4xl mx-auto px-6 lg:px-8">
            <form method="POST" action="{{ route('dashboard.slide.update', $slide) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="border-b border-gray-200 bg-gray-50/50 px-6 py-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">
                                        Perbarui teks dan tombol yang akan ditampilkan
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                ...
                                <div>
                                    ...
                                    <textarea id="subjudul"
                                              ...
                                              placeholder="Masukkan deskripsi atau subjudul...">{{ old('subjudul', $slide->subjudul) }}</textarea>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <x-text-input id="tombol_teks"
                                                      ...
                                                      type="text"
                                                      name="tombol_teks"
                                                      :value="old('tombol_teks', $slide->tombol_teks)"
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="tombol_url"
                                                      ...
                                                      type="text"
                                                      name="tombol_url"
                                                      :value="old('tombol_url', $slide->tombol_url)"
                        ...
                        <div class="border-b border-gray-200 bg-gray-50/50 px-6 py-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">
                                        Perbarui urutan dan status publikasi
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <select name="status"
                                            ...
                                            required>
                                        <option value="published" {{ old('status', $slide->status) == 'published' ? 'selected' : '' }}>
                                            📢 Published - Tampilkan di website
                                        </option>
                                        <option value="draft" {{ old('status', $slide->status) == 'draft' ? 'selected' : '' }}>
