    ...
    'defaults' => [
        ...
        'scanOptions' => [
            ...
            'exclude' => [
                ...
                base_path('app/Http/Controllers/ProfilController.php'),
                base_path('app/Http/Controllers/PostController.php'),
                base_path('app/Http/Controllers/HomeController.php'),
                base_path('app/Http/Controllers/AgendaController.php'),
                base_path('app/Http/Controllers/GaleriController.php'),
                base_path('app/Http/Controllers/KontakController.php'),
                base_path('app/Http/Controllers/StrukturOrganisasiController.php'),
                base_path('app/Http/Controllers/UnduhanController.php'),
            ],
